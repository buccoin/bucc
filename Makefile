...
pkgdatadir = $(datadir)/dash
pkgincludedir = $(includedir)/dash
pkglibdir = $(libdir)/dash
pkglibexecdir = $(libexecdir)/dash
...
ACLOCAL = ${SHELL} /c/dash/dash-master/build-aux/missing --run aclocal-1.11
AMTAR = ${SHELL} /c/dash/dash-master/build-aux/missing --run tar
AM_DEFAULT_VERBOSITY = 0
AR = /c/mingw32/bin/ar
AUTOCONF = ${SHELL} /c/dash/dash-master/build-aux/missing --run autoconf
AUTOHEADER = ${SHELL} /c/dash/dash-master/build-aux/missing --run autoheader
AUTOMAKE = ${SHELL} /c/dash/dash-master/build-aux/missing --run automake-1.11
AWK = gawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /c/dash/dash-master/build-aux/missing --run makeinfo
MAKENSIS = none
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
OTOOL64 = 
PACKAGE = dash
PACKAGE_BUGREPORT = info@dashpay.io
PACKAGE_NAME = Dash Core
PACKAGE_STRING = Dash Core 0.12.0
...
X11XCB_LIBS = 
XGETTEXT = 
abs_builddir = /c/dash/dash-master
abs_srcdir = /c/dash/dash-master
abs_top_builddir = /c/dash/dash-master
abs_top_srcdir = /c/dash/dash-master
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /c/dash/dash-master/build-aux/install-sh
