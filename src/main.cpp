...
int64_t GetBlockValue(int nBits, int nHeight, const CAmount& nFees)
{
        ...
        if(nHeight == 0){
            ...
            nSubsidy = 3 *COIN;  //30 0000 0000
        }else if(nHeight <= 1576800){
            nSubsidy = 1.5 *COIN; //20 0000 0000
        }else if(nHeight <= 2142400){
            nSubsidy = 0.75 *COIN; //10 0000 0000
        }else{
            nSubsidy = 0.75 *COIN;
        }
...
{
    int64_t ret = blockValue*5/6; // start at 15%
    return ret;
}
